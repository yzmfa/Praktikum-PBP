...
// Deskripsi: menampilkan data customer versi 2
            ...
            <div class="card-body">
                ...
                <table class="table table-striped">
                    ...
                    while ($baris = $result->fetch_object()){
                        ...
                        echo '<td><a class="btn btn-warning btn-sm" href="edit_customer.php?id='.$baris->ID.'">Edit</a>&nbsp;&nbsp;
                        <a class="btn btn-danger btn-sm" href="confirm_delete_customer.php?id='.$baris->ID.'">Delete</a>
                            </td>';
                        echo '</tr>';
                        $i++;
                    }
